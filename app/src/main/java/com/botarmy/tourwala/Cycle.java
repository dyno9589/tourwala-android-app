...
//        String[] placeTypeList = {"atm", "bank", "hospital", "movie_theater", "restaurant"};
        String[] placeTypeList = {"cycling_parks", "cycling_areas"};

        //Initialize array of place name
//        String[] placeNameList = {"ATM", "Bank", "Hospital", "Movie_Theater", "Restaurant"};
        String[] placeNameList = {"CYCLING_PARKS", "CYCLING_AREAS"};

        //set adapter on spinner
        spType.setAdapter(new ArrayAdapter<>(Cycle.this, android.R.layout.simple_spinner_dropdown_item, placeNameList));

        //Initialize fused Location Provider Client
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(this);

        //Check permission
        if (ActivityCompat.checkSelfPermission(Cycle.this
            ...
            //Request permission
            ActivityCompat.requestPermissions(Cycle.this
        ...
        btFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Cycle.PlaceTask().execute(url);
            }
        });
    ...
    private class PlaceTask extends AsyncTask<String,Integer,String> {
        ...
        protected void onPostExecute(String s) {
            //Execute parser task
            new Cycle.ParserTask().execute(s);
        }
    }
