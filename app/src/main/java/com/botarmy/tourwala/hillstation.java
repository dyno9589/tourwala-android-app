...
public class hillstation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hillstation);
...
//        String[] placeTypeList = {"atm", "bank", "hospital", "movie_theater", "restaurant"};
        String[] placeTypeList = {"hill_stations", "historical_places"};

        //Initialize array of place name
//        String[] placeNameList = {"ATM", "Bank", "Hospital", "Movie_Theater", "Restaurant"};
        String[] placeNameList = {"HILL_STATIONS", "HISTORICAL_PLACES"};

        //set adapter on spinner
        spType.setAdapter(new ArrayAdapter<>(hillstation.this, android.R.layout.simple_spinner_dropdown_item, placeNameList));

        //Initialize fused Location Provider Client
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(this);

        //Check permission
        if (ActivityCompat.checkSelfPermission(hillstation.this
            ...
            //Request permission
            ActivityCompat.requestPermissions(hillstation.this
        ...
        btFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new hillstation.PlaceTask().execute(url);
            }
        });
                            ...
                            map.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                                ...
                                public void onMapClick(@NonNull LatLng latLng) {
                                    ...
                                    if(networkInfo.isConnected() && networkInfo.isAvailable()){
                                        ...
                                        Toast.makeText(hillstation.this, "Please Check Connection", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        }
    ...
    private void GetAddress(double mLat, double mLng) {
        geocoder = new Geocoder(hillstation.this, Locale.getDefault());
    ...
    private class PlaceTask extends AsyncTask<String,Integer,String> {
        ...
        protected void onPostExecute(String s) {
            //Execute parser task
            new hillstation.ParserTask().execute(s);
        }
    }
